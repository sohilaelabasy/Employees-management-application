...
public class Main {
    ...
    static void adding() {
        ...
        input.nextLine();
        System.out.println("Enter employee employee address");

        String empAddress = input.nextLine();
        System.out.println("Enter employee employee salary");

        double empSalary = input.nextDouble();
        System.out.println("Enter employee employee department");
        input.nextLine();
